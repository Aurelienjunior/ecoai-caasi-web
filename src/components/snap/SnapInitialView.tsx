...
const SnapInitialView: React.FC<SnapInitialViewProps> = ({ onShutterClick }) => {
  return (
    <div className="space-y-6">
      <div className="bg-gray-900 rounded-2xl flex flex-col items-center justify-center text-white p-4 relative aspect-[3/4] max-h-[50vh]">
        ...
        <button onClick={onShutterClick} className="w-16 h-16 rounded-full bg-transparent border-[3px] border-green-400 flex items-center justify-center p-1 absolute bottom-8">
